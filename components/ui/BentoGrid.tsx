...
export const BentoGridItem = ({
  ...
  const handleCopy =() =>{
    navigator.clipboard.writeText('quckhnh1412@gmail.com');
    setCopied(true);
  }
  return (
    <div
    ...
    >
        <div className={`${id === 6 && 'flex justify-center'} h-full`}>
            ...
            <div className={`absolute right-0 w-full h-full -bottom-5 ${id===5 && 'w-full opacity-80'}`}>
                {spareImg && (
                    <img
                    src={spareImg}
                    alt={spareImg}
          ...
          <div className="flex gap-3 lg:gap-5 w-fit absolute -right-3 lg:-right-2 ">
            <div className="flex flex-col gap-3 lp:gap-8">
              {['React.js','Next.js','Css'].map(
                (item)=>(

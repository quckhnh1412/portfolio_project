...
const RecentProjects = () => {
  return (
    <div className="py-20" id="projects">
        ...
        <div className="flex flex-wrap items-center justify-center p-4 gap-x-14 gap-y-8 mt-5">
            {projects.map(({id,
                            title,
                            des,
                            img,
                ...
                <div key={id} className="sm:h-[41rem] h-[32rem] lg:min-h-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw]">
                    <PinContainer title={title} href={link}> 
                        <div className='relative flex items-center justify-center sm:w-[570px] w-[80vw]  overflow-hidden h-[20vh] lg:h-[30vh] mb-10'>
                            ...
                            <img src={img} className='z-10 absolute bottom-0 h-full' alt="" />
                        ...
                        <div className='flex items-center justify-between mt-7 mb-3'>
                            ...
                            <div className='flex justify-center items-center lg:text-xl md:text-xs text-sm text-purple'>
